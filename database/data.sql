...
INSERT INTO Users (user_id, role_id, username, password, email, full_name, date_of_birth, gender, phone, address, member_type, expiry_date, max_books, status, note, created_at, updated_at) VALUES
...
INSERT INTO Authors (author_id, name, biography, birth_date, nationality, created_at, updated_at) VALUES
...
INSERT INTO Publishers (publisher_id, name, address, phone, email, website, created_at, updated_at) VALUES
...
INSERT INTO Books (book_id, title, publisher_id, publication_year, edition, pages, language, description, cover_image, quantity, available_quantity, price, status, created_at, updated_at) VALUES
...
INSERT INTO Reservations (reservation_id, book_id, user_id, reservation_date, expiry_date, fulfilled_date, status, notes, created_at, updated_at) VALUES
(1, 1, 3, NOW(), DATE_ADD(NOW(), INTERVAL 7 DAY), NULL, 'pending', 'Awaiting approval', NOW(), NOW());

INSERT INTO Loans (loan_id, book_id, issued_by, returned_to, issued_date, due_date, returned_date, status, notes, created_at, updated_at) VALUES
(1, 1, 2, NULL, NOW(), DATE_ADD(NOW(), INTERVAL 14 DAY), NULL, 'active', 'Loan in good standing', NOW(), NOW());

INSERT INTO Book_Conditions (condition_id, book_id, loan_id, condition_before, condition_after, damage_description, assessed_by, assessed_date, notes, created_at) VALUES
(1, 1, 1, 'Good', NULL, NULL, 2, NOW(), 'Initial loan condition assessment', NOW());

INSERT INTO Fines (fine_id, loan_id, returned_to, issued_date, due_date, returned_date, status, notes, created_at, updated_at) VALUES
(1, 1, NULL, NOW(), DATE_ADD(NOW(), INTERVAL 7 DAY), NULL, 'unpaid', 'Late return fine', NOW(), NOW());

INSERT INTO Fine_Payments (payment_id, fine_id, amount, payment_date, payment_method, receive_by, notes, created_at) VALUES
