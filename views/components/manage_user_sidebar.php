<!-- <li class="nav-item <?= ($current_model == 'user' && $current_action != 'member') ? 'active' : '' ?>">
...
<li class="nav-item <?= ($current_model == 'user' || $current_model == 'role' || $current_model == 'permission') ? 'active' : '' ?>">
    ...
    <div id="collapseTwo" class="collapse <?= ($current_model == 'role' || $current_model == 'permission' || $current_model == 'user' ) ? 'show' : '' ?>" aria-labelledby="headingTwo">
        <div class="bg-transparent py-2 collapse-inner rounded">
            <a class="collapse-item <?= ($current_model == 'user') ? 'active' : '' ?>" 
