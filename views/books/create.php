            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="index.php?model=book&action=create" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="author" class="form-label">Chọn tác giả:</label>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="publication_year" id="publication_year" class="form-control" min="1000" max="9999" required>
                        </div>

                        <div class="mb-3">
                            <label for="edition" class="form-label">Tái bản:</label>
                            <input type="text" name="edition" id="edition" class="form-control" maxlength="50">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="language" id="language" class="form-control" maxlength="50">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="available_quantity" id="available_quantity" class="form-control" min="0" value="0">
                        </div>
...
<script>
    function addAuthor() {
    const authorsSelect = document.getElementById('author'); // Lấy dropdown danh sách tác giả
...
function addCategory() {
    const categoriesSelect = document.getElementById('category'); // Lấy dropdown danh sách thể loại
