        ...
        <div class="card-header py-2">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <a href="index.php?model=category&action=create" class="btn btn-primary ml-3">
                ...
                <table id="dataTable" class="table table-hover table-striped table-bordered">
                    ...
                    <tbody>
                        <?php foreach ($categories as $category): ?>
                            <tr>
                                <td class="text-center align-middle"><?= $category['category_id'] ?></td>
                                <td class="align-middle"><?= htmlspecialchars($category['name']) ?></td>
                                <td class="align-middle"><?= htmlspecialchars($category['description']) ?></td>
                                <td class="text-center align-middle">
                                    <div class="d-flex justify-content-center">
                                        <a href="index.php?model=category&action=edit&id=<?= $category['category_id'] ?>" class="btn btn-sm btn-outline-primary me-3" title="Chỉnh sửa">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <form action="index.php?model=category&action=delete&id=<?= $category['category_id'] ?>" method="POST" class="d-inline" onsubmit="return confirmDelete();">
